...
$config['licenseName'] = 'apps.omegatheme.com';
$config['licenseKey']  = 'TMNMBY86452TU57US9XD1NQKQEF8A';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://apps.omegatheme.com/otmanage/lib/ckfinder/userfiles/',
