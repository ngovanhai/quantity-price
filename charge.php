...
if (isset($_GET['charge_id'])) {
    ...
    if ($theCharge['status'] == 'accepted' || $theCharge['status'] == 'active') {
        activeClient($appId, $shop, $db, $shopify, $charge_id, $rootLink);
    } else {
        deactiveClient($appId, $shop, $db, $rootLink);
    }
} 
...
function activeClient($appId, $shop, $db, $shopify, $charge_id, $rootLink) {
...
function deactiveClient($appId, $shop, $db, $rootLink) {
